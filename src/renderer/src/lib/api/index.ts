...
export const GetExeIcon = (executablePath: string) => invoke<string>('GetExeIcon', { executablePath });
export const GetTotalRam = () => invoke<number>('GetTotalRam');
export const GetImageBase64 = (imagePath: string) => invoke<string>('GetImageBase64', { imagePath });
export const PickFile = () => invoke<string>('PickFile');
export const PickFolder = () => invoke<string>('PickFolder');
export const PickFileCustom = (title: string, filters: { displayName: string; pattern: string }[]) =>
...
export const SaveAppSettings = (settings: AppSettings) => invoke<void>('SaveAppSettings', { settings });
export const GetConfig = (executablePath: string) => invoke<LaunchOptions | null>('GetConfig', { executablePath });
export const SaveGameConfig = (options: LaunchOptions) => invoke<void>('SaveGameConfig', { options });

// Games Library
export const GetAllGames = () => invoke<GameInfo[]>('GetAllGames');
export const RemoveGame = (executablePath: string) => invoke<void>('RemoveGame', { executablePath });
...
export const RemoveScanFolder = (folderPath: string) => invoke<void>('RemoveScanFolder', { folderPath });
...
export const GetScanFolderConfig = (folderPath: string) => invoke<ScanFolderConfig>('GetScanFolderConfig', { folderPath });
export const BlacklistGame = (executablePath: string) => invoke<void>('BlacklistGame', { executablePath });
export const UnblacklistGame = (executablePath: string) => invoke<void>('UnblacklistGame', { executablePath });
...
export const LoadPrefixConfig = (prefixName: string) => invoke<LaunchOptions>('LoadPrefixConfig', { prefixName });
...
export const GetProtonReleases = (variantID: string) => invoke<GitHubRelease[]>('GetProtonReleases', { variantID });
